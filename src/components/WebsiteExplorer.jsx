        ...
        <main className="m-4 rounded bg-[#282b30] grid grid-cols-4">
            <div className="text-white p-4 rounded-l">
                ...
                <div className="list text-sm mt-4">
                    <h2 onClick={() => handleTabClick('Default')} className={`py-1 px-2 rounded mb-1 cursor-pointer ${
                            activeTab === 'Default' ? "bg-[#7289DA]" : "text-[#5d6269]"
                        }`}>
                        <Icon icon="bxs:dashboard" className="inline-flex -mt-[2px] mr-1" />Default
                    </h2>
                    <h2 onClick={() => handleTabClick('Social Media')} className={`py-1 px-2 rounded mb-1 cursor-pointer ${
                            activeTab === 'Social Media' ? "bg-[#7289DA]" : "text-[#5d6269]"
                        }`}>
                        <Icon icon="bi:phone" className="inline-flex -mt-[2px] mr-1" />Social Media
                    </h2>
                    <h2 onClick={() => handleTabClick('Entertainment')} className={`py-1 px-2 rounded mb-1 cursor-pointer ${
                            activeTab === 'Entertainment' ? "bg-[#7289DA]" : "text-[#5d6269]"
                        }`}>
                        <Icon icon="bxs:videos" className="inline-flex -mt-[2px] mr-1" />Entertainment
                    </h2>
                    <h2 onClick={() => handleTabClick('Developer & Tools')} className={`py-1 px-2 rounded mb-1 cursor-pointer ${
                            activeTab === 'Developer & Tools' ? "bg-[#7289DA]" : "text-[#5d6269]"
                        }`}>
                        <Icon icon="ant-design:code-outlined" className="inline-flex -mt-[2px] mr-1" />Developer & Tools
                    </h2>
                    <h2 onClick={() => handleTabClick('Shopping')} className={`py-1 px-2 rounded mb-1 cursor-pointer ${
                            activeTab === 'Shopping' ? "bg-[#7289DA]" : "text-[#5d6269]"
                        }`}>
                        <Icon icon="mdi:shopping-outline" className="inline-flex -mt-[2px] mr-1" />Shopping
                    </h2>
                    <h2 onClick={() => handleTabClick('News')} className={`py-1 px-2 rounded mb-1 cursor-pointer ${
                            activeTab === 'News' ? "bg-[#7289DA]" : "text-[#5d6269]"
                        }`}>
                        <Icon icon="material-symbols:news" className="inline-flex -mt-[2px] mr-1" />News
                    </h2>
                    <h2 onClick={() => handleTabClick('Maps')} className={`py-1 px-2 rounded mb-1 cursor-pointer ${
                            activeTab === 'Maps' ? "bg-[#7289DA]" : "text-[#5d6269]"
                        }`}>
                        <Icon icon="material-symbols:map" className="inline-flex -mt-[2px] mr-1" />Maps
                    </h2>
                    <h2 onClick={() => handleTabClick('Jobs / Employment')} className={`py-1 px-2 rounded mb-1 cursor-pointer ${
                            activeTab === 'Jobs / Employment' ? "bg-[#7289DA]" : "text-[#5d6269]"
                        }`}>
