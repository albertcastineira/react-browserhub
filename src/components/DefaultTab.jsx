...
export default function DefaultTab() {
  return (
    <>
        ...
        <WebsiteCard websiteName={"Gmail"} icon={"mdi:gmail"} link={"https://mail.google.com/mail/u/0/#inbox"}/>
        ...
        <WebsiteCard websiteName={"Github"} icon={"mdi:github"} link={"https://github.com/"}/>
